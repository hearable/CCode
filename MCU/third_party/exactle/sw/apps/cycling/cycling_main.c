 ...
 *
 *          $Date: 2016-04-13 14:47:48 -0700 (Wed, 13 Apr 2016) $
 *          $Revision: 6764 $
 *
...
/*************************************************************************************************/
/*!
*  \fn     cyclingSendCyclingSpeedMeasurement
*
...
/*************************************************************************************************/
/*!
*  \fn     cyclingSendCyclingPowerMeasurement
*
...
static void cyclingProcMsg(dmEvt_t *pMsg)
{
  ...
  switch(pMsg->hdr.event)
  {
    ...
    case DM_CONN_OPEN_IND:
      AttcMtuReq((dmConnId_t) pMsg->hdr.param, CYCLING_DEFAULT_MTU);
