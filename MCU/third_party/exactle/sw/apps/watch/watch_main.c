 ...
 *
 *          $Date: 2017-07-11 13:38:59 -0500 (Tue, 11 Jul 2017) $
 *          $Revision: 12347 $
 *
...
/*! Discovery states:  enumeration of services to be discovered in the slave role */
enum
{
...
/*! Start of GATT handles - Common to Slave and Master handle list */
#define WATCH_DISC_GATT_START           0

/*! Start of each service's handles in the the slave handle list - Slave Role */
...
/*! Pointers into handle list for each service's handles - Slave Role */
...
/* List of characteristics to configure after service discovery - Slave Role */
